...
class DatabaseGeminiProcessor:
    ...
    def get_pdf_prompt(self) -> str:
        ...
        1. Metadata: 
           ...
           - department (e.g. Department of Computer Science and Engineering, Department of Mathematics, Department of Applied Information Technology, ALWAYS include Department of in the department name and dont abbreviate it even if the text shows Dep of, you must include the word Department of in the department name)
